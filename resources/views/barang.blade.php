            ...
            <table class="w-full bg-white border border-gray-200" id="daftar-barang">
                <thead>
                    <tr class="bg-gray-100 border-b border-gray-200">
                        ...
                        <th class="px-4 py-2 text-center text-sm font-medium text-gray-600">Nama Barang</th>
                        <th class="px-4 py-2 text-center text-sm font-medium text-gray-600">Kategori</th>
                        <th class="px-4 py-2 text-center text-sm font-medium text-gray-600">Harga</th>
                        <th class="px-4 py-2 text-center text-sm font-medium text-gray-600">Stok</th>
                        <th class="px-4 py-2 text-center text-sm font-medium text-gray-600">Foto</th>
