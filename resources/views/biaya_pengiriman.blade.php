...
<div class="flex items-center justify-center">
    ...
    <div class="w-full h-full p-4">
        <!-- Judul -->
        <h2 class="text-lg text-center font-bold text-gray-700 mb-2">Daftar Biaya Pengiriman</h2>
        ...
        <thead>
            ...
            <th class="px-4 py-2 text-center text-sm font-medium text-gray-600">Wilayah</th>
            <th class="px-4 py-2 text-center text-sm font-medium text-gray-600">Nominal</th>
        ...
        <?php $index = 1; ?>
                    ...
                    <tr class="border-b">
                        ...
                        <td class="px-4 py-2 text-center text-sm text-gray-700">{{ $item->email}}</td>
                        <td class="px-4 py-2 text-center text-sm text-gray-700">{{ $item->nominal}}</td>
